...
class ProdukDesaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Produk-produk UMKM
        $produk = [
            ['cardTitle' => 'Olame Ompung, Bagas Godang', 'gambar' => 'images/produkdesa/p1.png'],
            ['cardTitle' => 'Kerajinan Tangan Kriya', 'gambar' => 'images/produkdesa/p2.jpg'],
            ['cardTitle' => 'Kain Tenun, Bagas Godang', 'gambar' => 'images/produkdesa/p3.jpg'],
        ];
